...
private slots:
    ...
    void slotActivateRunButtonAndStopTimer();
    void slotSendData();
...
private:
    ...
    void initPeriodComboBox();
    void initSigAndSlot();
    void initLayout();
    void initViewModel();

    void resizeView();
    void saveDataToFile(QStringList list);
     ...
     * @param[out] list
     */
    void getStringListByRawData(QString rawData, QStringList &list);
    QString revertStr(QString rawData);
...
private:
    ...
    QPushButton *disConnectionDeviceButton;
